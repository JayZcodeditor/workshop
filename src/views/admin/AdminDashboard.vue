<template>
  <div class="justify-center items-center min-h-screen relative p-6" id="home">

    <!-- breadcrumb end -->

    <div class="lg:flex justify-between items-center mb-6">
      <p class="text-2xl font-semibold mb-2 lg:mb-0">Hello, {{ username }}</p>
      <button
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Monthly sales</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Best Seller</p>
        <div class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0">
          <apexchart :options="barChartOptions" :series="barChartSeries" />
        </div>
      </div>

      <!-- Second Section: Chat (instead of Reviews Chart) -->
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Live Chat</p>
        <div class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0 flex flex-col">
          <!-- Chat Window -->
          ...
          <div class="flex items-center">
            <input type="text" class="w-full px-4 py-2 border rounded-l-md" placeholder="Type a message..." />
            <button class="px-4 py-2 bg-blue-500 text-white rounded-r-md hover:bg-blue-600">
              Send
            </button>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      chartSeries: [
        {
          name: 'Sales Data',
          data: [30, 40, 35, 50, 49, 60, 70, 91, 125, 140, 80, 110],
        },
      ],
  ...
  mounted() {
    this.username = localStorage.getItem('username') || 'Guest';  // Fallback to 'Guest' if not found
  }
}
